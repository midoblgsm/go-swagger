...
func templatesSchemabodyGotmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/schemabody.gotmpl", size: 1565, mode: os.FileMode(420), modTime: time.Unix(1434751043, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
...
func templatesSchemavalidatorGotmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/schemavalidator.gotmpl", size: 3845, mode: os.FileMode(420), modTime: time.Unix(1434753154, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
