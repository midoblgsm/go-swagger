...
func templatesSchemaGotmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/schema.gotmpl", size: 352, mode: os.FileMode(420), modTime: time.Unix(1434587008, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
...
func templatesSchemabodyGotmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/schemabody.gotmpl", size: 1291, mode: os.FileMode(420), modTime: time.Unix(1434596708, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
